...
Bayes' Theorum states P(A | B) = P(B | A) * P(A) / P(B)
So for Elvis P(identical twin | either type of twin) = (1) * (1/300) / (1/125 + 1/300) = .2941
There is a 29.41% chance that Elvis was an identical twin
